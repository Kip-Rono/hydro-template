...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index.html">Roger Obare</a></h1>
      ...
      <a href="#about" class="get-started-btn scrollto">Get to know me</a>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              Koinange Street <br>
              Nairobi, NB 535022<br>
              Kenya <br><br>
              <strong>Phone:</strong> +254 72100000<br>
              <strong>Email:</strong> info@rogerobare.com<br>
            </p>
          </div>
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <p>Subscribe to my newsletter to receive update on current projects and information.</p>
